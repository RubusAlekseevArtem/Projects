    ...
    init: function (options) {
      ...
      var buildSubTree = function (obj, html, i) {
        ...
        $(obj).each(function () {
          ...
          if (this.Children && this.Children.length)
            t +=
              '<ins class="tree-icon right-down-caret" id="icon-' +
              i +
              '"></ins>';
          else
      ...
      var checkParent = function (li, checked) {
        ...
        var $parent = $(li).closest(".subtree"),
          ...
          uncheckedChildren = $parent
            .children("li")
            .children("input:checkbox:not(:checked)"),
        ...
        var noSelectedChildren = !checkedChildren.length,
          someSelectedChildren =
            checkedChildren.length && uncheckedChildren.length,
        ...
        if ($parent.parent().length) checkParent($parent.parent(), checked);
      };
    ...
    val: function () {
      ...
      $(this.element)
        ...
        .each(function () {
          var li = $(this),
            parentLi =
              li.parent() && li.parent().parent() ? li.parent().parent() : null,
            parentLiIsChecked = parentLi
              ? parentLi.children("input").prop("checked")
              : false;
